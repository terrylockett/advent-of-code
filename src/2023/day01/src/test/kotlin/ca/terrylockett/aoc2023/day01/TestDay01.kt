...
class TestDay01 {
	...
	@Test
	fun testDay01_part1() {
		val part1InputFile = Resources.getInputFilePath(PART1_TEST_FILE_NAME).orElseThrow()
	...
	@Test
	fun testDay01_part2() {
		val part2InputFile = Resources.getInputFilePath(PART2_TEST_FILE_NAME).orElseThrow()
